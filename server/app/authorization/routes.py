...
def sign_up():
  try:
    ...
    new_author = Author(author_name=data['author_name'], author_email=data['author_email'], author_password=encrypt(data['author_password']), author_description=data['author_description'])
