...
class Author(db.Model):
    ...
    author_img = db.Column(db.String, unique=True, nullable=True)
    recipes = db.relationship('Recipe', backref='author')

    def json(self):
        return {'id': self.id,'author_name': self.author_name, 'author_email': self.author_email, 'author_password': self.author_password, 'author_description': self.author_description, 'author_img': self.author_img}
